...
<body>
    ...
    <details>
        ...
        <div>・このツールを使用するには<a href="chunirec.net">chunirec</a>への登録が必要です。</div>
        <div>・chunirecの設定でプロフィールが非公開になっているとこのツールを使用できません。</div>
        <div>・現在のベスト枠は2020/11/12更新分までの楽曲から計算しています。多分最新だと思いますが、更新が滞っていたらすみません。</div>
        <div>・昔のベスト枠は譜面定数の変動を考慮しておりません。現在の定数、現在のスコアでレートがいくつになるのかを計算しています。</div>
        <div>・chunirec APIの仕様でアクセスが集中すると結果が表示できないことがあります(15分で120アクセスまで)。少し時間をおいて再度お試しください。</div>
        <div>・気づいたことがありましたら<a href="twitter.com/cider33329448">Twitter</a>から報告をいただけますと幸いです。</div>
    </details>
